...
const Cart = ({ cart, setCart, show, setShow }) => {
  ...
  return (
    <div
      className="w-full h-full z-20 bg-black bg-opacity-90 top-0 overflow-y-auto overflow-x-hidden fixed sticky-0"
      id="chec-div"
    >
      <div
        className="w-full absolute z-20 right-0 h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700"
        id="checkout"
      >
            ...
            <div className="flex flex-col md:h-screen px-14 py-20 justify-between overflow-y-auto">
              ...
              <div>
                ...
                <button
                  ...
                  className={`text-base px-4 leading-none w-full py-5 ${
                    isCartEmpty
                      ? "bg-gray-300 border-gray-300 cursor-not-allowed"
                      : "bg-gray-800 border-gray-800"
                  } border focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                    isCartEmpty ? "focus:ring-gray-300" : "focus:ring-gray-800"
                  } text-white`}
